...
Write-Host "   Model: Gemma3:4b | Recommended: 8+ GB RAM"             -ForegroundColor Gray
...
} catch { ERR "No internet connection. Required for initial setup (~5 GB total download)." }
...
Write-Host "   choose qwen2.5:latest model and start chatting." -ForegroundColor Gray
Write-Host ""
